...
function Get-DreamSkinText {
  ...
  $catalog = @{
    'en-US' = @{
      StatusPaused = 'Status: Paused'; StatusRunning = 'Status: Running'; StatusStopped = 'Status: Stopped'; RevealLabel = 'Wallpaper reveal: {0}%'
      Apply = 'Apply or reapply'; Resume = 'Resume skin'; Pause = 'Pause skin'
      ChangeBackground = 'Change background image'; BackgroundTitle = 'Choose a Codex Dynamic Skin background image'
      BackgroundUpdated = 'Background image updated.'; ImportZip = 'Import theme ZIP...'
      ImportTitle = 'Choose a Codex Dynamic Skin theme ZIP'; SaveCurrent = 'Save current theme'
      SavePrompt = 'Theme name:'; SaveTitle = 'Save Codex Dynamic Skin theme'; Saved = 'Saved: {0}'
      ...
      ApplyStarted = 'Skin apply started'; Applying = 'Applying skin...'; SessionTransportPoster = 'Remote session detected: wallpaper pinned to a still frame'; SessionTransportVideo = 'Local session detected: video wallpaper resumed'
      ...
      ImageFilter = 'Wallpaper files|*.png;*.jpg;*.jpeg;*.webp;*.mp4;*.webm|Image files|*.png;*.jpg;*.jpeg;*.webp|Video files|*.mp4;*.webm|All files|*.*'
      ...
      UpdateTitle = 'Codex Dynamic Skin Update'; UpdateAvailable = 'Codex Dynamic Skin {0} is available.'
      UpdateQuestion = 'Open the GitHub download page?'; UpToDate = 'Codex Dynamic Skin {0} is up to date.'
      UpdateFailed = 'Could not check for updates.'
      RestartPrompt = 'Codex must restart once to enable Codex Dynamic Skin. Unsaved input may be lost. Restart now?'
      LaunchCancelled = 'Codex Dynamic Skin launch was cancelled; Codex was not changed.'
      RestoreClose = 'Restore will close Codex, remove Codex Dynamic Skin and its CDP session, then reopen the official app. Continue?'
      RestoreCloseNoRelaunch = 'Restore will close Codex and remove Codex Dynamic Skin plus its CDP session. Continue?'
      ...
      CommunityStartStateReconciliationFailed = 'Codex Dynamic Skin could not reconcile the previous local session safely.'
      CommunityStartInjectorFailed = 'The local Codex Dynamic Skin renderer could not start.'
      ...
      CommunityStartInternalFailure = 'Codex Dynamic Skin could not complete the local start operation.'
      CommunityStartTimedOut = 'Codex Dynamic Skin start and visible verification timed out. Background recovery was left running; active-theme files were preserved.'
      CommunityStartInvalidResult = 'Codex Dynamic Skin start did not return a valid bounded result.'
    ...
    'zh-CN' = @{
      StatusPaused = '状态：已暂停'; StatusRunning = '状态：运行中'; StatusStopped = '状态：未运行'; RevealLabel = '壁纸透出：{0}%'
      Apply = '应用或重新应用'; Resume = '继续显示皮肤'; Pause = '暂停皮肤'
      ChangeBackground = '更换背景图'; BackgroundTitle = '选择 Codex 动态壁纸 背景图'
      BackgroundUpdated = '背景图已更新。'; ImportZip = '导入主题 ZIP…'
      ImportTitle = '选择 Codex 动态壁纸 主题 ZIP'; SaveCurrent = '保存当前主题'
      SavePrompt = '输入主题名称：'; SaveTitle = '保存 Codex 动态壁纸 主题'; Saved = '已保存：{0}'
      ...
      ApplyStarted = '已开始应用皮肤'; Applying = '正在应用皮肤…'; SessionTransportPoster = '已切换到远程会话：壁纸固定为静态帧'; SessionTransportVideo = '已切换到本地会话：视频壁纸恢复播放'
      ...
      ImageFilter = '壁纸文件|*.png;*.jpg;*.jpeg;*.webp;*.mp4;*.webm|图片文件|*.png;*.jpg;*.jpeg;*.webp|视频文件|*.mp4;*.webm|所有文件|*.*'
      PauseNoSession = '没有可连接的活动会话；已记录暂停，当前窗口可能仍显示皮肤。'
      PauseSucceeded = '皮肤已暂停。'; PauseFailed = '已记录暂停，但卸下当前皮肤失败；可重试暂停或完全恢复 Codex。'
      UpdateTitle = 'Codex 动态壁纸 更新'; UpdateAvailable = 'Codex 动态壁纸 {0} 已发布。'
      UpdateQuestion = '是否打开 GitHub 下载页面？'; UpToDate = 'Codex 动态壁纸 {0} 已是最新版本。'
      UpdateFailed = '无法检查更新。'
      RestartPrompt = 'Codex 需要重启一次才能启用动态壁纸，未保存的输入可能丢失。现在重启吗？'
      LaunchCancelled = '已取消启动动态壁纸；Codex 未发生改变。'
      RestoreClose = '恢复操作将关闭 Codex，移除动态壁纸及其 CDP 会话，然后重新打开官方应用。是否继续？'
      RestoreCloseNoRelaunch = '恢复操作将关闭 Codex，并移除动态壁纸及其 CDP 会话。是否继续？'
      ...
      CommunityStartStateReconciliationFailed = '动态壁纸无法安全协调此前的本机会话。'
      CommunityStartInjectorFailed = '本地动态壁纸渲染器无法启动。'
      CommunityStartRendererVerificationFailed = '当前主题未通过可见渲染验证。'
      CommunityStartSuperseded = '较新的主题或暂停操作已取代本次应用。'
      CommunityStartInternalFailure = '动态壁纸无法完成本地启动操作。'
      CommunityStartTimedOut = '动态壁纸启动与可见渲染验证超时；后台恢复仍在继续，活动主题文件已保留。'
      CommunityStartInvalidResult = '动态壁纸启动没有返回有效的有界结果。'
